...
### https://doi.org/10.1117/12.3078631  - DOI of Base Paper
...
### 🚀 Key Innovations (Unique Solution)
...
│
├── fraud_detection_model.py    # Main Source Code (Data Gen, Model, Training)
├── requirements.txt            # List of Python dependencies
├── README.md                   # This instruction file
│
├── Visualizations/             # Output images generated by the script
│   ├── confusion_matrix_ta-hgat_proposed_model.png
│   └── comparative_analysis.png
│
└── Financial Fraud Detection Report.pdf  # Comprehensive Case Study Document
```
